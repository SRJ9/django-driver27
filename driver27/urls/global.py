...
urlpatterns = [
    ...
    url(r'^driver/record-redir/$', views.driver_record_redirect_view, name='dr27-driver-record-redir'),
    url(r'^driver/', include('driver27.urls.driver')),
    url(r'^team/(?P<team_id>\d+)/$', views.team_profile_view, name='team-profile'),
    url(r'^team/record-redir/$', views.team_record_redirect_view, name='dr27-team-record-redir'),
