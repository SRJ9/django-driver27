...
urlpatterns = [
    ...
    url(r'^team/record/(?P<record>[-\w\d]+)/races$', views.team_record_by_race_view, name='season-team-record-by-race'),
    url(r'^team/record/(?P<record>[-\w\d]+)/doubles-in-race$', views.team_record_double_view,
        name='season-team-record-double'),
