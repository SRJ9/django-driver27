...
urlpatterns = [
    ...
    url(r'^(?P<competition_slug>[-\w\d]+)/(?P<year>\d+)/driver$', views.driver_view, name='season-driver'),
    url(r'^(?P<competition_slug>[-\w\d]+)/(?P<year>\d+)/team$', views.team_view, name='season-team'),
